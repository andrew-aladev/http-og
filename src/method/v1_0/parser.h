...
extern const size_t          OGHTTP_METHOD_v1_0_PARSER_ALPHABET_MAX_LENGTH;
...
inline oghttp_method_v1_0_parser_state_fast_t oghttp_method_v1_0_get_next_state(
  oghttp_method_v1_0_parser_state_fast_t state, oghttp_symbol_fast_t byte)
{
  oghttp_symbol_fast_t symbol = OGHTTP_METHOD_v1_0_PARSER_SYMBOL_BY_BYTES[byte];
  if (OGHTTP_METHOD_v1_0_PARSER_ALPHABET_LENGTH != OGHTTP_METHOD_v1_0_PARSER_ALPHABET_MAX_LENGTH && symbol == OGHTTP_METHOD_v1_0_PARSER_UNDEFINED_SYMBOL) {
    return OGHTTP_METHOD_v1_0_PARSER_INITIAL_STATE;
  }

  return OGHTTP_METHOD_v1_0_NEXT_STATE_BY_LAST_SYMBOLS[state * OGHTTP_METHOD_v1_0_PARSER_ALPHABET_LENGTH + symbol];
}

inline bool oghttp_method_v1_0_is_finished(oghttp_method_v1_0_parser_state_fast_t state)
{
  return state < OGHTTP_METHOD_v1_0_PARSER_CONSTANTS_LENGTH;
}
