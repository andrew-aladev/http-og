...
const hog_processor_state_fast_t HOG_PROCESSOR_SEPARATOR_MIN_LENGTH = 1;
const hog_processor_state_fast_t HOG_PROCESSOR_SEPARATOR_MAX_LENGTH = 65535;
...
extern inline bool hog_processor_separator_is_valid(hog_processor_state_fast_t state);
