...
const ogh_processor_state_fast_t OGH_PROCESSOR_STATUS_CODE_ANY_FROM_STANDARD_INITIAL_STATE = 0;

const ogh_processor_state_fast_t OGH_PROCESSOR_STATUS_CODE_ANY_FROM_STANDARD_MIN_LENGTH = 3;
const ogh_processor_state_fast_t OGH_PROCESSOR_STATUS_CODE_ANY_FROM_STANDARD_MAX_LENGTH = 3;

#define ALLOWED_BYTES_LENGTH OGH_MAX_SYMBOL + 1

// clang-format off

const bool OGH_PROCESSOR_STATUS_CODE_ANY_FROM_STANDARD_ALLOWED_BYTES[ALLOWED_BYTES_LENGTH] = {
