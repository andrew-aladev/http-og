...
const hog_processor_state_fast_t HOG_PROCESSOR_STATUS_CODE_1_0_CONSTANTS_LENGTH = 15;
...
const uint_fast16_t HOG_PROCESSOR_STATUS_CODE_1_0_ALPHABET_LENGTH     = 6;
const uint_fast16_t HOG_PROCESSOR_STATUS_CODE_1_0_ALPHABET_MAX_LENGTH = HOG_MAX_SYMBOL + 1;
