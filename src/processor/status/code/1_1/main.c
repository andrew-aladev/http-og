...
const ogh_byte_fast_t OGH_PROCESSOR_STATUS_CODE_1_1_UNDEFINED_SYMBOL = OGH_MAX_SYMBOL;

#define SYMBOL_BY_BYTES_LENGTH OGH_PROCESSOR_STATUS_CODE_1_1_ALPHABET_MAX_LENGTH

// clang-format off

const ogh_byte_t OGH_PROCESSOR_STATUS_CODE_1_1_SYMBOL_BY_BYTES[SYMBOL_BY_BYTES_LENGTH] = {
