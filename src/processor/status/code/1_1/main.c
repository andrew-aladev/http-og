...
const ogh_symbol_fast_t OGH_PROCESSOR_STATUS_CODE_1_1_UNDEFINED_SYMBOL = OGH_MAX_SYMBOL;

#define SYMBOL_BY_BYTES_LENGTH OGH_PROCESSOR_STATUS_CODE_1_1_ALPHABET_MAX_LENGTH

// clang-format off

const ogh_symbol_t OGH_PROCESSOR_STATUS_CODE_1_1_SYMBOL_BY_BYTES[SYMBOL_BY_BYTES_LENGTH] = {
  [0 ... SYMBOL_BY_BYTES_LENGTH - 1] = OGH_PROCESSOR_STATUS_CODE_1_1_UNDEFINED_SYMBOL,
  [49] = 0,
  [48] = 1,
  [50] = 2,
  [51] = 3,
...
#define NEXT_STATE_BY_LAST_SYMBOLS_LENGTH (89 + 1) * OGH_PROCESSOR_STATUS_CODE_1_1_ALPHABET_LENGTH

// clang-format off

const ogh_processor_status_code_1_1_state_t OGH_PROCESSOR_STATUS_CODE_1_1_NEXT_STATE_BY_LAST_SYMBOLS[NEXT_STATE_BY_LAST_SYMBOLS_LENGTH] = {
  [0 ... NEXT_STATE_BY_LAST_SYMBOLS_LENGTH - 1] = OGH_PROCESSOR_STATUS_CODE_1_1_INITIAL_STATE,
  [690] = 70,
  [692] = 72,
  [693] = 75,
  [694] = 77,
