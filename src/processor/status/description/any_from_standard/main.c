...
const hog_processor_state_fast_t HOG_PROCESSOR_STATUS_DESCRIPTION_ANY_FROM_STANDARD_MIN_LENGTH = 1;
const hog_processor_state_fast_t HOG_PROCESSOR_STATUS_DESCRIPTION_ANY_FROM_STANDARD_MAX_LENGTH = 65535;
