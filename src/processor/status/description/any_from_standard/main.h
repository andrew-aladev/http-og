...
extern const size_t HOG_PROCESSOR_STATUS_DESCRIPTION_ANY_FROM_STANDARD_MIN_LENGTH;
extern const size_t HOG_PROCESSOR_STATUS_DESCRIPTION_ANY_FROM_STANDARD_MAX_LENGTH;
