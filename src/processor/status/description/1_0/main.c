...
const ogh_processor_state_fast_t OGH_PROCESSOR_STATUS_DESCRIPTION_1_0_INITIAL_STATE =
  OGH_PROCESSOR_STATUS_DESCRIPTION_1_0_CONSTANTS_LENGTH;
...
const ogh_byte_fast_t OGH_PROCESSOR_STATUS_DESCRIPTION_1_0_UNDEFINED_SYMBOL = OGH_MAX_SYMBOL;

#define SYMBOL_BY_BYTES_LENGTH OGH_PROCESSOR_STATUS_DESCRIPTION_1_0_ALPHABET_MAX_LENGTH

// clang-format off

const ogh_byte_t OGH_PROCESSOR_STATUS_DESCRIPTION_1_0_SYMBOL_BY_BYTES[SYMBOL_BY_BYTES_LENGTH] = {
