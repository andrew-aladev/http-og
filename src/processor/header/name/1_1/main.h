...
inline ogh_processor_state_fast_t ogh_processor_header_name_1_1_get_next_state(ogh_processor_state_fast_t state,
                                                                               ogh_byte_fast_t            byte)
{
  ...
  if (OGH_PROCESSOR_HEADER_NAME_1_1_ALPHABET_LENGTH != OGH_PROCESSOR_HEADER_NAME_1_1_ALPHABET_MAX_LENGTH &&
      symbol == OGH_PROCESSOR_HEADER_NAME_1_1_UNDEFINED_SYMBOL) {
    OGH_LOG_ERROR("header_name_1_1 processor received invalid byte: %u", byte);
    return OGH_PROCESSOR_HEADER_NAME_1_1_INITIAL_STATE;
  }

  return OGH_PROCESSOR_HEADER_NAME_1_1_NEXT_STATE_BY_LAST_SYMBOLS[state *
                                                                    OGH_PROCESSOR_HEADER_NAME_1_1_ALPHABET_LENGTH +
                                                                  symbol];
}
