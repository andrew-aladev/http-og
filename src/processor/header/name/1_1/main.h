  ...
  ogh_byte_fast_t            byte)
{
  ...
  if (
    OGH_PROCESSOR_HEADER_NAME_1_1_ALPHABET_LENGTH != OGH_PROCESSOR_HEADER_NAME_1_1_ALPHABET_MAX_LENGTH &&
  ...
  return OGH_PROCESSOR_HEADER_NAME_1_1_NEXT_STATE_BY_LAST_SYMBOLS
    [state * OGH_PROCESSOR_HEADER_NAME_1_1_ALPHABET_LENGTH + symbol];
}
