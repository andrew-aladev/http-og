...
extern const ogh_processor_state_fast_t OGH_PROCESSOR_METHOD_1_1_INITIAL_STATE;

extern const ogh_processor_state_fast_t OGH_PROCESSOR_METHOD_1_1_CONSTANTS_LENGTH;
...
inline ogh_processor_state_fast_t ogh_processor_method_1_1_get_next_state(ogh_processor_state_fast_t state,
                                                                          ogh_symbol_fast_t          byte)
{
  ogh_byte_fast_t symbol = OGH_PROCESSOR_METHOD_1_1_SYMBOL_BY_BYTES[byte];

  // We need to verify symbol if alphabet is not full.
  if (OGH_PROCESSOR_METHOD_1_1_ALPHABET_LENGTH != OGH_PROCESSOR_METHOD_1_1_ALPHABET_MAX_LENGTH &&
      symbol == OGH_PROCESSOR_METHOD_1_1_UNDEFINED_SYMBOL) {
...
inline bool ogh_processor_method_1_1_is_valid(ogh_processor_state_fast_t state)
{
