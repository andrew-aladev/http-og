...
const hog_processor_state_fast_t HOG_PROCESSOR_METHOD_1_1_CONSTANTS_LENGTH = 39;

const hog_processor_state_fast_t HOG_PROCESSOR_METHOD_1_1_INITIAL_STATE = HOG_PROCESSOR_METHOD_1_1_CONSTANTS_LENGTH;

const uint_fast16_t HOG_PROCESSOR_METHOD_1_1_ALPHABET_LENGTH     = 23;
const uint_fast16_t HOG_PROCESSOR_METHOD_1_1_ALPHABET_MAX_LENGTH = HOG_MAX_SYMBOL + 1;

const hog_symbol_fast_t HOG_PROCESSOR_METHOD_1_1_UNDEFINED_SYMBOL = HOG_MAX_SYMBOL;

#define SYMBOL_BY_BYTES_LENGTH HOG_PROCESSOR_METHOD_1_1_ALPHABET_MAX_LENGTH
...
extern inline bool hog_processor_method_1_1_is_valid(hog_processor_state_fast_t state);
