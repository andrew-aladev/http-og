...
inline ogh_processor_state_fast_t ogh_processor_method_0_9_get_next_state(ogh_processor_state_fast_t state,
...
inline bool ogh_processor_method_0_9_is_valid(ogh_processor_state_fast_t state)
{
