...
extern const ogh_symbol_fast_t OGH_PROCESSOR_METHOD_1_0_UNDEFINED_SYMBOL;
extern const ogh_symbol_t      OGH_PROCESSOR_METHOD_1_0_SYMBOL_BY_BYTES[];
...
{
  ogh_symbol_fast_t symbol = OGH_PROCESSOR_METHOD_1_0_SYMBOL_BY_BYTES[byte];
