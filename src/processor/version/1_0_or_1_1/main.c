...
const size_t HOG_PROCESSOR_VERSION_1_0_or_1_1_CONSTANTS_LENGTH = 2;
...
const size_t HOG_PROCESSOR_VERSION_1_0_or_1_1_ALPHABET_LENGTH     = 3;
const size_t HOG_PROCESSOR_VERSION_1_0_or_1_1_ALPHABET_MAX_LENGTH = HOG_MAX_SYMBOL + 1;
