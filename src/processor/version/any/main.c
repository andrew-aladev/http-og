...
const hog_processor_state_fast_t HOG_PROCESSOR_VERSION_ANY_INITIAL_STATE = 0;

const hog_processor_state_fast_t HOG_PROCESSOR_VERSION_ANY_MIN_LENGTH = 1;
const hog_processor_state_fast_t HOG_PROCESSOR_VERSION_ANY_MAX_LENGTH = 65535;

#define ALLOWED_BYTES_LENGTH HOG_MAX_SYMBOL + 1

// clang-format off

const bool HOG_PROCESSOR_VERSION_ANY_ALLOWED_BYTES[ALLOWED_BYTES_LENGTH] = {
