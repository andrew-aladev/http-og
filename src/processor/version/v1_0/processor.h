...
#if !defined(HOG_PROCESSOR_VERSION_v1_0_H)
#define HOG_PROCESSOR_VERSION_v1_0_H
...
inline bool hog_processor_version_v1_0_is_finished(hog_processor_state_fast_t state)
{
  return state == HOG_PROCESSOR_VERSION_v1_0_CONSTANT_LENGTH;
}

#endif // HOG_PROCESSOR_VERSION_v1_0_H
