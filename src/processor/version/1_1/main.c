...
const ogh_byte_t OGH_PROCESSOR_VERSION_1_1_CONSTANT_SYMBOLS[] = {0x31, 0x2e, 0x31};

const ogh_processor_state_fast_t OGH_PROCESSOR_VERSION_1_1_CONSTANT_LENGTH = 3;

extern inline ogh_processor_state_fast_t ogh_processor_version_1_1_get_next_state(ogh_processor_state_fast_t state,
